...
class HighlightOneScreen extends StatelessWidget {
  HighlightOneScreen({Key? key}) : super(key: key);
        ...
        child: Scaffold(
            ...
            appBar: CustomAppBar(
                ...
                leading: AppbarImage1(
                    ...
                    margin:
                        EdgeInsets.only(left: 23.h, top: 19.v, bottom: 16.v),
                    onTap: () {
                      onTapArrowleftone(context);
                    }),
                title: AppbarSubtitle1(
                    text: "lbl_travel".tr, margin: EdgeInsets.only(left: 26.h)),
                actions: [
                  AppbarImage2(
                      svgPath: ImageConstant.imgGroup76,
                      margin: EdgeInsets.fromLTRB(24.h, 25.v, 24.h, 24.v))
                ]),
            body: Container(
                ...
                decoration: BoxDecoration(
                    image: DecorationImage(
                        image: AssetImage(ImageConstant.imgGroup1603),
                        fit: BoxFit.cover)),
                child: SingleChildScrollView(
                    padding: EdgeInsets.only(top: 630.v),
                    child: SizedBox(
                        height: 197.v,
                        width: 419.h,
                        child:

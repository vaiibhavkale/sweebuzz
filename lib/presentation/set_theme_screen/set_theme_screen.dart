...
class SetThemeScreen extends StatelessWidget {
  SetThemeScreen({Key? key}) : super(key: key);
  GlobalKey<NavigatorState> navigatorKey = GlobalKey();
  String radioGroup = "";
  TextEditingController darkvalueoneController = TextEditingController();
  TextEditingController systemdefaultController = TextEditingController();
  @override
                      ...
                      child: SingleChildScrollView(
                          child: Padding(
                              ...
                              child: Column(children: [
                                ...
                                SizedBox(height: 19.v),
                                CustomTextFormField(
                                    controller: systemdefaultController,
                                    hintText: "lbl_system_default".tr,

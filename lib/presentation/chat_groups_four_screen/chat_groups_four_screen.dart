import '../chat_groups_four_screen/widgets/listlinefour_item_widget.dart';
...
class ChatGroupsFourScreen extends StatelessWidget {
  ChatGroupsFourScreen({Key? key}) : super(key: key);
                      ...
                      child: Padding(
                          ...
                          child: ListView.separated(
                              ...
                              separatorBuilder: (context, index) {
                                return Padding(
                                    padding:
                                        EdgeInsets.symmetric(vertical: 6.0.v),
                                    child: SizedBox(
                                        width: 374.h,
                                        child: Divider(
                                            height: 1.v,

import '../profile_blogs_three_screen/widgets/gridtext1_item_widget.dart';
...
class ProfileBlogsThreeScreen extends StatelessWidget {
  ProfileBlogsThreeScreen({Key? key}) : super(key: key);
                                ...
                                Padding(
                                    ...
                                    child: GridView.builder(
                                        ...
                                        itemBuilder: (context, index) {
                                          return Gridtext1ItemWidget();
                                        })),
                                Padding(
                                    padding: EdgeInsets.only(
                                        left: 16.h, top: 8.v, right: 16.h),
                                    child: Row(
                                        mainAxisAlignment:
